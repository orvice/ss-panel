...
$app->group('/password', function () {
    ...
    $this->post('/reset', 'App\Controllers\AuthController:handleReset');
    $this->get('/token', 'App\Controllers\AuthController:token');
    $this->post('/token', 'App\Controllers\AuthController:handleToken');
})->add(new Guest());
