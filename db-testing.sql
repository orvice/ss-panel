...
CREATE TABLE `sp_config` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT '2014-11-04 00:00:00',
  PRIMARY KEY (`id`)
...
(1,	'user',	'user@sspanel.dev',	'9003d1df22eb4d3829915070385194c8',	'123gxopp',	1460651176,	0,	0,	21474836480,	21567,	1,	1,	7,	0,	1460209591,	0,	'2016-04-23 16:00:00',	46,	1,	0,	1456593755,	'rc4-md5',	0,	'127.0.0.1');
