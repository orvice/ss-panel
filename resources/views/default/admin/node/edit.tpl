                            ...
                            <div class="row">
                                <fieldset class="col-sm-6">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
									        <input class="form-control" id="protocol_param" type="text" value="{$node->protocol_param}" {if $this->user->protocol !=='auth_simple'||$this->user->protocol !=='auth_sha1'||$this->user->protocol !=='auth_sha1_v2'} disabled="disabled"{/if}>
										</div>
								    </div>
