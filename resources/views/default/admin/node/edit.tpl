                            ...
                            <div class="row">
                                <fieldset class="col-sm-6">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
									        <input class="form-control" id="protocol_param" type="text" value="{$node->protocol_param}" {if $node->protocol == "auth_simple" || $node->protocol == "auth_sha1" || $node->protocol == "auth_sha1_v2"} disabled="false" {/if}>
										</div>
								    </div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
									        <input class="form-control" id="obfs_param" type="text" value="{$node->obfs_param}" {if $node->obfs == "http_simple" || $node->obfs == "http_post" || $node->obfs == "tls1.2_ticket_auth"} disabled="false"{/if}>
										</div>
								    </div>
