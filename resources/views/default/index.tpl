...
<div class="section no-pad-bot" id="index-banner">
    <div class="container">
        ...
        <div class="row center">
            <h5 class="header col s12 light">{$lang->get('index.info')}</h5>
            {$homeIndexMsg}
        </div>
        {if $user->isLogin}
            <div class="row center">
                <a href="/user" id="download-button" class="btn-large waves-effect waves-light orange">{$lang->get('index.enter-user-center')}/a>
            </div>
        {else}
        <div class="row center">
