...
<div class="container">
    ...
    <p>
        Shadowsocks 客户端在本地创建 sock5 代理服务器，并通过与远程服务器的加密 TCP 隧道来实现加速网络。本服务只提供用户加速访问正常授权网络服务，实际上不存在任何<a href="http://wenshu.court.gov.cn/content/content?DocID=970f7940-1024-4c3e-bdd1-a76000af7d33">侵入国家事务、国防建设、尖端科学技术领域的计算机信息系统</a>的能力（参见<a href="/tos">服务条款</a>），如果你对这一过程有不理解的地方，可以参考<a href="http://vc2tea.com/whats-shadowsocks/">写给非专业人士看的 Shadowsocks 简介</a>或<a href="https://shadowsocks.org/">官方网站</a>。
    </p>
    <p>
    ...
    <p>
    <ul>
        <li>需要网络加速，特别是对不同地区速度差异明显的网站加速的用户。</li>
    ...
    <h4>局限性</h4>
    <p>服务器都分布在中国境外，因此你无法使用它访问只在中国大陆有版权的资源，例如一些音乐、视频网站。你可以通过一些其他渠道（如Y\o\u\T\u\b\e）来获取这些资源。</p>
