...
<div>
    <ul class="uk-nav uk-nav-default">
        ...
        <li class="uk-nav">
            <router-link tag="li" :to="{ name: 'users' }" exact>
            <a href="#">
        ...
        <li class="uk-nav">
            <router-link tag="li" :to="{ name: 'invites' }" exact>
            <a href="#">
        ...
        <li class="uk-nav">
            ...
            <a href="#">
                <span
                    class="uk-margin-small-right" uk-icon="icon: cloud-download">
                </span>
            {{ $t("user-nav.traffic-log") }}</a>
            </router-link>
        </li>
        <li class="uk-nav">
            <router-link tag="li" :to="{ name: 'config' }" exact>
            <a href="#">
                <span class="uk-margin-small-right" uk-icon="icon: settings">
                </span>
            {{ $t("admin-nav.config") }} </a>
            </router-link>
        </li>
        <li class="uk-nav">
            <router-link tag="li" :to="{ name: 'mail' }" exact>
            <a href="#">
                <span class="uk-margin-small-right" uk-icon="icon: mail">
                </span>
            {{ $t("admin-nav.mail-setting") }} </a>
            </router-link>
        </li>
