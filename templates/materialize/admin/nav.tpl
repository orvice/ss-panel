			  ...
			  <!--   <li><a class="dropdown-button" href="#!" data-activates="change_announcement">修改公告<span class="mdi-navigation-arrow-drop-down right"></span></a></li> -->
			  	<li><a class="dropdown-button" href="#!" data-activates="change_announcement">修改公告<i class="mdi-navigation-arrow-drop-down right"></i></a></li>
	                <ul id="change_announcement" class="dropdown-content">
						  ...
						  <li><a class="waves-effect waves-yellow" href="change_announcement.php?ca=index_button"><span>首页</span><br/>按钮</a></li>
						  <li><a class="waves-effect waves-yellow" href="change_announcement.php?ca=index_Custom"><span>首页</span><br/>自定义内容</a></li>
						  <li class="divider"></li>
						  ...
						  <li class="divider"></li>
						  <li><a class="waves-effect waves-yellow" href="change_announcement.php?ca=user_node_Announcement_node"><span>节点列表</span><br/>普通节点</a></li>
						  <li><a class="waves-effect waves-yellow" href="change_announcement.php?ca=user_node_Announcement_node_pro"><span>节点列表</span><br/>pro节点</a></li>
						  <li class="divider"></li>
						  <li><a class="waves-effect waves-yellow" href="change_announcement.php?ca=user_invite_Announcement_color_orange"><span>邀请好友</span><br/>橙色</a></li>
						  <li><a class="waves-effect waves-yellow" href="change_announcement.php?ca=user_invite_Announcement_color_blue"><span>邀请好友</span><br/>蓝色</a></li>
					</ul>
			...
			<ul id="nav-mobile" class="side-nav">	
			    ...
			    <li class="no-padding">
			          <ul class="collapsible collapsible-accordion">
			            <li class="bold"><a class="collapsible-header waves-effect waves-yellow">修改公告<i class="mdi-navigation-arrow-drop-down right"></i></a>
			              <div class="collapsible-body" style="display: none;">
			                <ul>
			                  <li><a class="waves-effect waves-yellow" href="change_announcement.php?ca=index_Announcement">首页</a></li>
							  <li><a class="waves-effect waves-yellow" href="change_announcement.php?ca=index_button"><span>首页</span>按钮</a></li>
							  <li><a class="waves-effect waves-yellow" href="change_announcement.php?ca=index_Custom"><span>首页</span>自定义内容</a></li>
							  <li class="divider"></li>
							  <li><a class="waves-effect waves-yellow" href="change_announcement.php?ca=footer_Announcement">用户建议</a></li>
							  <li class="divider"></li>
							  <li><a class="waves-effect waves-yellow" href="change_announcement.php?ca=tos_content">用户协议 </a></li>
